/* Silk — animated WebGL silk background (React Bits), adapted to TypeScript. */
...
type Uniforms = Record<string, { value: number | Color }>;

function SilkPlane({ uniforms }: { uniforms: Uniforms }) {
